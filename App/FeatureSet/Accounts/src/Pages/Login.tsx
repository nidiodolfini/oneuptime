              ...
              footer={
                <div className="actions text-center mt-4">
                  {/* Medgrupo fork: botao de login DIRETO via Keycloak (projeto Medgrupo).
                      <a href> (nao <Link>): /identity/oidc/:p/:o e rota GET de servidor
                      (Identity/API/OIDC.ts:155) que redireciona ao Keycloak, sem a tela
                      de e-mail. IDs = config OIDC do projeto Medgrupo; se recriar a
                      config, atualizar. Ver docs/oneuptime-sso-keycloak.md (gitops-plataform). */}
                  <a
