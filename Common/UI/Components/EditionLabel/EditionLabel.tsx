...
//
// 12.0.6: upstream reescreveu o componente (+1596 linhas de UX de licenca) —
// o stub segue substituindo o arquivo INTEIRO; interface conferida nos 3
// consumidores (Login, AdminDashboard Header, Dashboard Footer): so import
// default + className opcional.
//
